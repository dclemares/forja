...
const indicatorOn: React.CSSProperties = {
  background: 'linear-gradient(180deg, rgba(255,255,255,.4), rgba(255,255,255,0) 50%), linear-gradient(180deg,#E6C06A,#B07E22)',
...
const fab: React.CSSProperties = {
  ...
  background: 'linear-gradient(180deg, rgba(255,255,255,.45), rgba(255,255,255,0) 46%), linear-gradient(180deg,#E6C06A,#B07E22)',
  display: 'flex',
  alignItems: 'center',
  justifyContent: 'center',
  cursor: 'pointer',
  marginTop: -10,
  boxShadow: 'inset 0 2px 0 rgba(255,245,210,.85), 0 4px 0 #7C5413, 0 8px 12px rgba(20,12,4,.5), 0 0 16px rgba(255,205,90,.45)',
}
