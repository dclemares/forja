...
const logo: React.CSSProperties = { width: 70, height: 70, borderRadius: 22, background: 'linear-gradient(180deg,#FFD75C,#EDA31E)', border: '3px solid #7A4A12', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', boxShadow: 'inset 0 2px 0 rgba(255,240,200,.7), 0 5px 0 #A66A18, 0 9px 14px rgba(30,18,6,.4)' }
